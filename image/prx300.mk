...
define Device/PRX_ETH
  $(Device/PRX_GENERIC)
  $(Device/NAND)
  DEVICE_PACKAGES += ltq-gphy-fw-prx3xx $(PON_ETH_PACKAGES) base-files-platform-prx300
endef
...
define Device/PRX_HGU
  $(Device/PRX_GENERIC)
  $(Device/NAND)
  DEVICE_PACKAGES += $(PON_BASE_PACKAGES) $(PON_HGU_PACKAGES)
endef
...
define Device/PRX321_SFU_QSPI_512_PON
  $(Device/PRX_SFU)
  DEVICE_DTS := prx321-sfu-qspi-512-pon
  DEVICE_TITLE := PRX321 SFU QSPI 512MB PON WAN
endef
TARGET_DEVICES += PRX321_SFU_QSPI_512_PON
...
define Device/PRX321_SFU_LAB_PON
  $(Device/PRX_SFU)
  DEVICE_DTS := prx321-sfu-lab-pon
  DEVICE_TITLE := PRX321 SFU LAB PON WAN
  # extra packages to support I2C mux
  DEVICE_PACKAGES += kmod-i2c-mux kmod-i2c-mux-pca954x
endef
TARGET_DEVICES += PRX321_SFU_LAB_PON
...
define Device/PRX120_EVA_QSPI_PON
  $(Device/PRX_SFU)
  DEVICE_DTS := prx120-eva-qspi-pon
  DEVICE_TITLE := PRX120 EVA QSPI PON WAN
endef
TARGET_DEVICES += PRX120_EVA_QSPI_PON
...
define Device/PRX321_HGU_QSPI_PON
  $(Device/PRX_HGU)
  DEVICE_DTS := prx321-hgu-qspi-pon
  DEVICE_TITLE := PRX321 HGU QSPI PON WAN
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(PON_DEBUG_PACKAGES) \
			$(UGW_PACKAGES) $(UGW_DIAG_PACKAGES) $(MPE_ACCEL_PACKAGES)
endef
TARGET_DEVICES += PRX321_HGU_QSPI_PON

define Device/PRX321_HGU_QSPI_ETH
  $(Device/PRX_ETH)
  DEVICE_DTS := prx321-hgu-qspi-eth
  DEVICE_TITLE := PRX321 HGU QSPI ETH WAN
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(PON_DEBUG_PACKAGES) \
			$(UGW_PACKAGES) $(UGW_DIAG_PACKAGES) $(MPE_ACCEL_PACKAGES)
endef
TARGET_DEVICES += PRX321_HGU_QSPI_ETH
...
define Device/PRX321_GW_11AX
  ...
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES) $(UGW_DIAG_DSL_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) \
			$(PON_DEBUG_PACKAGES) \
...
define Device/PRX321_GW_11AX_GSW120
  $(Device/PRX_HGU)
  DEVICE_DTS := prx321-gw-11ax-gsw120
  DEVICE_TITLE := PRX321 GW 11AX GSW120
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES) $(UGW_DIAG_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) \
			$(PON_DEBUG_PACKAGES) \
			$(MPE_ACCEL_PACKAGES)
endef
TARGET_DEVICES += PRX321_GW_11AX_GSW120
...
define Device/PRX321_GW_GFAST_11AX_ETH
  $(Device/PRX_ETH)
  DEVICE_DTS := prx321-gw-gfast-11ax-eth
  DEVICE_TITLE := PRX321 GW GFAST 11AX ETH
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES) $(UGW_DIAG_DSL_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) \
			$(DSL_CPE_GFAST_PACKAGES_PRX) $(DSL_CPE_GFAST_PACKAGES_DEBUG) $(MPE_ACCEL_PACKAGES) \
			$(PON_DEBUG_PACKAGES)
endef
TARGET_DEVICES += PRX321_GW_GFAST_11AX_ETH

define Device/PRX321_GW_11AX_GSW120_ETH
  $(Device/PRX_ETH)
  DEVICE_DTS := prx321-gw-11ax-gsw120-eth
  DEVICE_TITLE := PRX321 GW 11AX GSW120 ETH
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES) $(UGW_DIAG_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) \
			$(MPE_ACCEL_PACKAGES) \
			$(PON_DEBUG_PACKAGES)
endef
TARGET_DEVICES += PRX321_GW_11AX_GSW120_ETH
...
define Device/PRX321_GW_ETH_GFAST_11AX_SEC
  ...
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES_SEC) $(UGW_DIAG_DSL_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI) \
...
define Device/PRX321_GW_11AX_SP_ETH_WAN_GPHY
  ...
  ROOTFS_PREPARE := add-servicelayer-schema
  DEVICE_PACKAGES += $(UGW_PACKAGES_SDL) $(UGW_DIAG_PACKAGES) $(WAV600_PACKAGES_UCI) $(WAV600_UGW_PACKAGES_UCI)
endef
